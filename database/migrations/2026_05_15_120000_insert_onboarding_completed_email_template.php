...
return new class extends Migration
{
    ...
    {
        $definition = EmailTemplateRegistry::get(EmailTemplateRegistry::ONBOARDING_COMPLETED);
        ...
        $row = [
            'id' => (string) Str::uuid(),
            'key' => EmailTemplateRegistry::ONBOARDING_COMPLETED,
    ...
    public function down(): void
    {
        DB::table('email_templates')
            ->where('key', EmailTemplateRegistry::ONBOARDING_COMPLETED)
            ->delete();
    }
};
