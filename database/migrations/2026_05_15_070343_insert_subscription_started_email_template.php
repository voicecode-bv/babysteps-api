...
return new class extends Migration
{
    ...
    {
        $definition = EmailTemplateRegistry::get(EmailTemplateRegistry::SUBSCRIPTION_STARTED);
        ...
        $row = [
            'id' => (string) Str::uuid(),
            'key' => EmailTemplateRegistry::SUBSCRIPTION_STARTED,
    ...
    public function down(): void
    {
        DB::table('email_templates')
            ->where('key', EmailTemplateRegistry::SUBSCRIPTION_STARTED)
            ->delete();
    }
};
